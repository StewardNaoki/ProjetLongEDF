...
python3 main.py --epoch $num_epoch --batch $num_batch --valpct 0.2 --num_thread $num_thread --l2_reg 0.001 --num_var $num_var --num_const $num_const --num_prob 100000 --log --loss MSE --alpha 10 --num_neur 200 --num_deep_layer 2

python3 main.py --epoch $num_epoch --batch $num_batch --valpct 0.2 --num_thread $num_thread --l2_reg 0.001 --num_var $num_var --num_const $num_const --num_prob 100000 --log --loss PCL --alpha 100 --num_deep_layer 2

python3 main.py --epoch $num_epoch --batch $num_batch --valpct 0.2 --num_thread $num_thread --l2_reg 0.001 --num_var $num_var --num_const $num_const --num_prob 100000 --log --loss GCL --alpha 10 --num_neur 200 --num_deep_layer 2
