...
# num_neur=32
# num_layer=1
# python3 main_EDF.py --epoch $num_epoch --batch $num_batch --num_thread $num_thread --log --num_json_max $num_data --loss MSE --network CNN --dropout --num_deep_layer $num_layer --num_neur $num_neur --alpha $alpha --beta $beta
